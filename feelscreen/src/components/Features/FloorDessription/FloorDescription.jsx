...
const FloorDescription = () => {
	...
	return (
		<FloorDes>
			<FloorTop>
				<div>
					<div className="hidden 5f">
						<img className="hidden 5f" src={`/assets/5f.png`} alt="5층" />
					</div>
					<div className="hidden 3f">
						<img className="hidden 3f" src={`/assets/3f.png`} alt="3층" />
					</div>
					<div className="hidden 2f">
						<img className="hidden 2f" src={`/assets/2f.png`} alt="2층" />
					</div>
					<div className="hidden 1f">
						<img className="hidden 1f" src={`/assets/1f.png`} alt="1층" />
					</div>
					<div className="hidden 0f">
						<img className="hidden 0f" src={`/assets/0f.png`} alt="전체" />
					</div>
				</div>
				<FloorButtons>
					<div>
						<span>5F</span>
						<FloorButton onClick={() => handelFloor('5f.png')}>
							프렌즈 비어
						</FloorButton>
					</div>
					<div>
						<span>3F</span>
						<FloorButton onClick={() => handelFloor('3f.png')}>
							연습타석
						</FloorButton>
					</div>
					<div>
						<span>2F</span>
						<FloorButton onClick={() => handelFloor('2f.png')}>
							INFO / 룸
						</FloorButton>
					</div>
					<div>
						<span>1F</span>
						<FloorButton onClick={() => handelFloor('1f.png')}>
							주차장
						</FloorButton>
					</div>
				</FloorButtons>
